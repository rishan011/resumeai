          ...
          <CardContent className="pt-8">
            ...
            >
              <motion.div variants={itemVariants} className="space-y-2">
                <Label htmlFor="email" className="text-neutral-300 text-sm font-semibold tracking-wide ml-1">Work Email</Label>
                <div className="relative group/input">
                  <Input 
                    ...
                    required
                    className="bg-neutral-900/50 border-white/[0.08] text-white placeholder:text-neutral-600 focus-visible:ring-violet-500 h-12 rounded-xl transition-all group-hover/input:border-violet-500/30"
                  />
                  <div className="absolute inset-0 rounded-xl bg-violet-500/5 opacity-0 group-focus-within/input:opacity-100 pointer-events-none transition-opacity" />
                </div>
              </motion.div>

              <motion.div variants={itemVariants} className="space-y-2">
                <Label htmlFor="password" className="text-neutral-300 text-sm font-semibold tracking-wide ml-1">Password</Label>
                <div className="relative group/input">
                  <Input 
                    id="password" 
                    type="password"
              ...
              <motion.div variants={itemVariants} className="relative py-4">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-[#0A0A0B] px-4 text-neutral-500 font-bold tracking-widest">Or Continue With</span>
                </div>
              </motion.div>
              ...
              <motion.div variants={itemVariants}>
                <Button 
                  ...
                  className="w-full h-12 bg-transparent border-white/[0.08] hover:bg-white/5 text-white rounded-xl flex items-center justify-center gap-3 transition-all hover:border-violet-500/30"
                >
